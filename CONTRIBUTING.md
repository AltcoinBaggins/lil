Contributing to Cortez Core
============================

The Cortez Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Cortez Core project, and is not to be
confused with overall Cortez Network Protocol consensus changes.

Whether a pull request is merged into Cortez Core rests with the project merge
...
Patches that change Cortez consensus rules are considerably more involved than
...
Where a patchset proposes to change the Cortez consensus, it must have been
...
The project leader is the release manager for each Cortez Core release.
