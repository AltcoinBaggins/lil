...
#define MyAppName "Cortez Core"
#define MyAppPublisher "2022 Cortez Core Developers"
#define MyAppURL "https://cortezcoin.com"
#define MyAppExeName "cortez-qt.exe"
#define MyAppExtraData "https://explorer.cortezcoin.com/bootstraps/CRTZ/bootstrap.zip"
...
OutputDir=.\output
OutputBaseFilename=CortezSetup
...
[Files]
Source: ".\package\cortez-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Cortez\Cortez-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Cortez\Cortez-Qt,strDataDir|{userappdata}\Cortez\}');
  Result := True;
end;
