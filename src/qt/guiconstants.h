...
/* Cortez GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Cortez"
#define QAPP_ORG_DOMAIN "cortez.org"
#define QAPP_APP_NAME_DEFAULT "Cortez-Qt"
#define QAPP_APP_NAME_TESTNET "Cortez-Qt-testnet"
