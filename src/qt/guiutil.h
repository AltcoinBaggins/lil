...
/** Utility functions used by the Cortez Qt UI.
 */
namespace GUIUtil
{
...
// Render CRTZ addresses in monospace font
...
// Parse "cortez:" URI into recipient object, return true on successful parsing
