...
"""Verify that starting cortez with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start cortez with -? for help text")
        ...
        self.log.info("Start cortez with -version for version information")
